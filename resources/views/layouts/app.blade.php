...
<body>
  <div id="app" class="relative">
    <nav class="fixed top-0 left-0 right-0 navbar navbar-expand-md navbar-light bg-cyan-700">
      <div class="container">
        <div class="flex justify-center content-center gap-x-3">
            <img src="{{ asset('img/unj.png') }}" alt="logo" class="w-11 drop-shadow-l">
            <h2 class="text-2xl text-violet-50 text-center">
    ...
    <main class="container-fluid pb-3 flex-grow-1 d-flex flex-column flex-sm-row overflow-auto">
        <div class="row flex-grow-sm-1 flex-grow-1">
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-white drop-shadow-2xl">
            ...
            <div class="content col overflow-auto h-100">
                @yield('content')
            </div>
        </div>
    </main>
