...
<a {{ $attributes->merge(['class' => 'btn bg-'.$btnColor.'-600 hover:bg-'.$btnColor.'-700 hover:shadow-lg focus:bg-'.$btnColor.'-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-'.$btnColor.'-800 active:shadow-lg transition duration-150 ease-in-out rounded text-white text-sm']) }}>
